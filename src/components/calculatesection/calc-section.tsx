  ...
  return (
    <div className="p-4 flex flex-col justify-center items-center px-10">
      <div className='flex items-start flex-col'>
        <div className="mb-4">
          <label htmlFor="principal" className="block text-violet font-[Open Sans] pb-3 px-6">
            Enter amount to invest ($)
          </label>
          <Input className='border-none p-4 w-[349px] px-6 flex bg-light-green text-center rounded-[16px] opacity-50'
            type="number"
            id="principal"
