...
import image3 from "@/app/asset/images/connectimg.svg";
    ...
    <section>
      ...
      <main>
        ...
        <div className="flex items-center py-6 px-10 justify-between">
          <div className="inline-flex flex-col items-center gap-9 pl-10">
            <div className="flex flex-col justify-center items-center pb-6">
              <h1 className=" text-violet font-bold text-2xl py-5">Connect, Share, and Grow with Us</h1>
              <p className="text-[16px] text-violet w-[368px] text-center">Join the network of investors who trust us for profitable investments.</p>
            </div>
            <Button className="flex w-[200px]">
              <div className="flex justify-center items-center gap-4">
                Get Started
